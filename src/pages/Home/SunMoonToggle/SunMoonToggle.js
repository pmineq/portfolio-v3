...
export default function SunMoonToggle() {
    ...
    return (_jsx("button", { ref: ref, type: "button", "aria-pressed": isDark, onClick: handleSwap, className: cx('home-bg-mountain__item', {
            ...
            if (e.animationName === 'fadeItemUp')
                setInitAppear(false); // 최초 1회만
        } }));
}
